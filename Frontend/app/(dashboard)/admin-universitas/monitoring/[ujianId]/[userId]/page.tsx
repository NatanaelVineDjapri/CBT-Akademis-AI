...
export default function AdminMonitoringPesertaPage({ params }: { params: Promise<{ ujianId: string; userId: string }> }) {
                ...
                <tr key={a.attempt_ke} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-center">
                    {a.foto_bukti?.length > 0 ? (
                      <Link
                        href={`/admin-universitas/monitoring/${ujianSlug}/${pesertaSlug}/${a.attempt_ke}`}
