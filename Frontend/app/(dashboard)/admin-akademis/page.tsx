  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col gap-3">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/admin-akademis/maintenance"
...
function PengumumanCard() {
  const { data } = useSWR("/pengumuman", getPengumuman, { revalidateOnFocus: false });
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col gap-3">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/admin-akademis/pengumuman"
          className="text-xs border rounded-lg px-3 py-1 transition-colors hover:opacity-80"
          style={{ color: "var(--color-primary)", borderColor: "var(--color-primary)" }}
        >
          Kelola
      ...
      {!data ? (
        ...
        <div className="flex flex-col gap-2">
          {(data as Pengumuman[]).slice(0, 3).map(p => (
