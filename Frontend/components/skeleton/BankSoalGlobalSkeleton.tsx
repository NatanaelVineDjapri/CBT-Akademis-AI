      ...
      {Array.from({ length: count }).map((_, i) => (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-7 rounded-full bg-white/30 flex-1" />
          </div>
          ...
          <div className="bg-white/20 rounded-xl px-3 py-2 flex items-center justify-between gap-4">
            <div className="flex flex-col gap-1 min-w-0 flex-1">
              <div className="h-2 rounded bg-white/30 w-16" />
              <div className="h-3 rounded bg-white/30 w-full" />
            </div>
            <div className="flex flex-col gap-1 items-end shrink-0">
              <div className="h-2 rounded bg-white/30 w-16" />
              <div className="h-3 rounded bg-white/30 w-6" />
            </div>
          </div>
        </div>
      ))}
